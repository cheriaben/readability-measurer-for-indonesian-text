...
.txtsukukata {
    ...
    <body>
    <h2 class="titlepengukuran">Ukur Bacaan Baru</h2>
    <form class="formpengukuran" name="form1" method="post" action="perlbacaan" target="mainFrame">
      ...
      <label class="labelkatasulit">Kata Sulit Jika Kata Terdiri Lebih Dari:</label>
    <select class="txtsukukata" name="batasansukukata" id="batasansukukata">
    <option value="3">Tiga Suku Kata</option>
    <option value="4">Empat Suku Kata</option>
  	<option value="5">Lima Suku Kata</option>
    </select>
    <input name="chkstem" type="checkbox" class="chkboxstem" value="Ya">
    <label class="labelchk">Gunakan Proses Stemming</label>
